...
const BookCard = ({ book }) => {
    return (
        ...
        <div className=" rounded-lg transition-shadow duration-300">
            <div
                className="flex flex-col sm:flex-row sm:items-center sm:h-70  sm:justify-center gap-4"
            >
                <div className="sm:h-60 sm:flex-shrink-0 border rounded-md">
                    <Link to={`/books/${book._id}`}>
                        ...
                        <img
                            ...
                            alt=""
                            className="w-full bg-cover rounded-md cursor-pointer hover:scale-105 transition-all duration-200"
                        />
                ...
                <div>
                    ...
                    <button
                        ...
                        className="btn-primary px-6 flex items-center gap-1 px-6 py-2 ">
